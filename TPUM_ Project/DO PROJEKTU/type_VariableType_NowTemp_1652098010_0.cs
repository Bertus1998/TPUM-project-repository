...
{
    public class VariableType_NowTemp_1652098010_0 : CodeGenVariableTypeBase
    {
        public VariableType_NowTemp_1652098010_0(string browseName,
        ...
        {   
            Console.WriteLine("VariableType_NowTemp_1652098010_0::Initialize");
            ...
            this.GetNode().BrowseName  = "NowTemp";
            this.GetNode().DisplayName = "NowTemp";
            ...
            string defaultValueStr  = "20.000000";
