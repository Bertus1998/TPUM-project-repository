...
{
    public class VariableType_Heat_2031185702_0 : CodeGenVariableTypeBase
    {
        public VariableType_Heat_2031185702_0(string browseName,
        ...
        {   
            Console.WriteLine("VariableType_Heat_2031185702_0::Initialize");
            ...
            this.GetNode().BrowseName  = "Heat";
            this.GetNode().DisplayName = "Heat";
            this.GetNode().Description = "";
            this.GetNode().Historizing = false;
            this.GetNode().MinimumSamplingInterval = 0;
            this.GetNode().AccessLevel = AccessLevels.None| AccessLevels.CurrentRead| AccessLevels.CurrentWrite| AccessLevels.HistoryRead| AccessLevels.HistoryWrite| AccessLevels.StatusWrite| AccessLevels.TimestampWrite;
