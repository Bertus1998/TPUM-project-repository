...
{
    public class VariableType_Name_420871476_0 : CodeGenVariableTypeBase
    {
        public VariableType_Name_420871476_0(string browseName,
        ...
        {   
            Console.WriteLine("VariableType_Name_420871476_0::Initialize");
            ...
            this.GetNode().BrowseName  = "Name";
            this.GetNode().DisplayName = "Name";
